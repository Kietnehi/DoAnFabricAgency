...
?>
//Lấy thông tin nhân viên đối Tác
$partner_staff_stmt = $conn->prepare("SELECT ECode, Fname, Lname FROM employee WHERE Role = 'PartnerStaff' AND SCode = ?");
...
<body>
    ...
    <p><strong>Nhân viên đối tác:</strong></p>
